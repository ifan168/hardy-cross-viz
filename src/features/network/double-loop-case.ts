...
export const doubleLoopCase: NetworkCase = {
  ...
  nodes: [
    { id: "R", name: "水源 R", demand: -90, position: { x: -330, y: 240 }, kind: "source" },
    { id: "A", name: "节点 A", demand: 10, position: { x: -100, y: 240 }, kind: "junction" },
